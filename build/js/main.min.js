...
var _buttonPlay = require("./modules/button-play");
var _initSwiper = require("./modules/init-swiper.js");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _buttonPlay.initVideo)();
    (0, _initSwiper.initSliders)();
  });
});
...
},{"./modules/button-play":2,"./modules/form-validate/form":4,"./modules/init-swiper.js":10,"./modules/modals/init-modals":11,"./modules/tabs/init-tabs":13,"./utils/ios-vh-fix":17}],2:[function(require,module,exports){
"use strict";
...
var buttonPlay = document.querySelector('.video__button-play');
...
exports.initSliders = exports.createFeedbackSlider = exports.createCoachesSlider = void 0;
var _swiper = _interopRequireDefault(require("../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var coachesSlider = document.querySelector('.coaches__content');
var feedbackSlider = document.querySelector('.feedback-swiper');
var createCoachesSlider = function createCoachesSlider() {
  if (coachesSlider) {
    (function () {
      return new _swiper.default('.coaches__content', {
        // Optional parameters
...
exports.createCoachesSlider = createCoachesSlider;
var createFeedbackSlider = function createFeedbackSlider() {
  if (feedbackSlider) {
    (function () {
      return new _swiper.default('.feedback-swiper', {
        // Optional parameters
        direction: 'horizontal',
        slidesPerView: 1,
        // Navigation arrows
...
exports.createFeedbackSlider = createFeedbackSlider;
    ...
    function update(force) {
      ...
      for (var _i10 = loopFrom; _i10 < loopTo; _i10 += 1) {
        if (_i10 >= from && _i10 <= to) {
          var _slideIndex = getSlideIndex(_i10);
          if (typeof previousTo === 'undefined' || force) {
            appendIndexes.push(_slideIndex);
          } else {
            if (_i10 > previousTo) appendIndexes.push(_slideIndex);
            if (_i10 < previousFrom) prependIndexes.push(_slideIndex);
          }
        }
      }
